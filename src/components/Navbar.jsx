               ...
               <div className="flex items-center space-x-4">
                  ...
                  >
                     ...
                     <path fill-rule="evenodd" clip-rule="evenodd"
                        fill="#FFD700"
                        d="M18 16V11C18 7.68629 16.7357 4.73571 14.4645 2.96447C14.3066 2.84119 14.153 2.72529 14 2.6166V2C14 0.89543 13.1046 0 12 0C10.8954 0 10 0.89543 10 2V2.6166C9.84703 2.72529 9.69336 2.84119 9.53553 2.96447C7.26429 4.73571 6 7.68629 6 11V16L4 18V19H20V18L18 16ZM8 11C8 8.23858 9.34315 5.34315 12 4.34315C14.6569 5.34315 16 8.23858 16 11V17H8V11Z" />
                  </svg>
                  ...
                  <svg
                     ...
                     <path
                        fill="#1E88E5"
                        d="M12 14c-5 0-9 2.5-9 5v2h18v-2c0-2.5-4-5-9-5z"
                     >
                        <animate
                           attributeName="d"
                           values="M12 14c-5 0-9 2.5-9 5v2h18v-2c0-2.5-4-5-9-5z;
              M12 14c-6 0-10 2.5-10 5v2h20v-2c0-2.5-4-5-10-5z;
              M12 14c-5 0-9 2.5-9 5v2h18v-2c0-2.5-4-5-9-5z"
                           dur="2s"
                           repeatCount="indefinite"
                        />
                     </path>
                  ...
                  >
                     ...
                     >
                        <animate
                           attributeName="d"
                           values="M16 13v-2H7V8l-5 4 5 4v-3z;
              M16 11v-2H7V6l-5 4 5 4v-3z;
